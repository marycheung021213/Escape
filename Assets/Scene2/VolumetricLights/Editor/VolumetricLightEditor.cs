...
namespace VolumetricLights {
    ...
    public partial class VolumetricLightEditor : Editor {
        ...
        SerializedProperty blendMode, raymarchPreset, raymarchQuality, raymarchMinStep, raymarchMaxSteps, dithering, jittering, useBlueNoise, renderQueue, sortingLayerID, sortingOrder, alwaysOn;
